...
//hash key added with endianness changed in all otherwise the test was not working ROHIT
const TX_TEST_INPUTS = [
  {
    txid: hex.decode('c061c23190ed3370ad5206769651eaf6fac6d87d85b5db34e30a74e0c4a6da3e'),
    hash: '3edaa6c4e0740ae334dbb5857dd8c6faf6ea5196760652ad7033ed9031c261c0',
    index: 0,
    amount: 550n,
  ...
  },
  {
    ...
    hash:'0d9ae8a4191b3ba5a2b856c21af0f7a4feb97957ae80725ef38a933c906519a2',
    index: 0,
    amount: 600n,
    script: hex.decode('76a91411dbe48cc6b617f9c6adaf4d9ed5f625b1c7cb5988ac'),
  },
  {
    ...
    hash: 'c7a4a37d38c2b0de3d3b3e8d8e8a331977c12532fc2a4632df27a89c311ee2fa',
    index: 0,
    amount: 600n,
    script: hex.decode('76a91411dbe48cc6b617f9c6adaf4d9ed5f625b1c7cb5988ac'),
  },
...
should('BTC: tx (from P2PKH)', async () => {
  ...
  const tx = new btc.Transaction(opts,1); // 1 added to fix Version mismatch ROHIT
  ...
  const tx2 = new btc.Transaction(opts, 1); // 1 added to fix Version mismatch ROHIT
...
should('BTC: tx (from bech32)', async () => {
  const privKey = hex.decode('0101010101010101010101010101010101010101010101010101010101010101');
  const tx32 = new btc.Transaction({ version: 1 },1);
