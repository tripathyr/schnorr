! function(r) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = r();
        ...
        var e;
        e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, e.segwit_addr_ecc = r()
    }
}(function() {
    return function() {
        function r(e, n, t) {
            ...
            for (var a = "function" == typeof require && require, i = 0; i < t.length; i++) o(t[i]);
            return o
        }
        return r
    }()({
        1: [function(r, e, n) {
            ...
            function a(r, e) {
                ...
                var n = o(r),
                    ...
                    u = h[a],
                    f = h[i];
                if (-1 != s && -1 != u && -1 != f && (2 * u - f - s + 2046) % 1023 == 0) {
                    var l = (u - s + 1023) % 1023;
                    if (l >= e) return [];
                    var p = s + 26 * l;
                    return p % 33 ? [] : [l]
                ...
                for (var l = 0; l < e; l++) {
                    var d = i ^ (0 == a ? 0 : c[(u + l) % 1023]);
                    if (0 != d) {
                        var g = a ^ (0 == t ? 0 : c[(s + l) % 1023]);
                        if (0 != g) {
                            var v = h[g],
                                _ = (h[d] - v + 1023) % 1023;
                            if (!(_ >= e || l == _)) {
                                var m = a ^ (0 == t ? 0 : c[(s + _) % 1023]);
                                if (0 != m) {
                                    var C = 1023 - h[c[l] ^ c[_]];
                                    if (!((v + C + 26 * _) % 33)) {
                                        var p = h[m] + C + 26 * l;
                                        if (!(p % 33)) return l < _ ? [l, _] : [_, l]
                                    }
                                }
                            }
                        }
            ...
            function s(r) {
                var e, n = [];
                for (e = 0; e < r.length; ++e) n.push(r.charCodeAt(e) >> 5);
                for (n.push(0), e = 0; e < r.length; ++e) n.push(31 & r.charCodeAt(e));
                return n
            }

            function u(r, e) {
                for (var n = [], t = r; t < e; ++t) n.push(t);
                return n
            }

            function f(r, e, n) {
                if (r.length > 90) return {
                    error: "Too long",
                    pos: u(90, r.length)
                };
                var o, f = !1,
                ...
                for (o = 0; o < r.length; ++o) {
                    if (r.charCodeAt(o) < 33 || r.charCodeAt(o) > 126) return {
                        error: "Invalid character",
                        pos: [o]
                    };
                    if (r.charAt(o) >= "a" && r.charAt(o) <= "z" && (f = !0, p)) return {
                        error: "Mixed case",
                        pos: [o]
                    };
                    if (r.charAt(o) >= "A" && r.charAt(o) <= "Z" && (p = !0, f)) return {
                        error: "Mixed case",
                        pos: [o]
                    }
                }
                r = r.toLowerCase();
                var c = r.lastIndexOf("1");
                if (-1 == c) return {
                    error: "Missing separator '1'",
                    pos: null
                };
                if (c < 1 || c + 7 > r.length) return {
                    error: "Separator '1' at invalid position",
                    pos: [c]
                };
                var h = r.substring(0, c),
                    d = [];
                for (o = c + 1; o < r.length; ++o) {
                    var g = l.indexOf(r.charAt(o));
                    if (-1 === g) return {
                        error: "Invalid character",
                        pos: [o]
                    };
                ...
                if (-1 == e.indexOf(h)) return {
                    error: "Unknown part before the separator '1'",
                    pos: u(0, h.length)
                };
                var v = i(s(h).concat(d)) ^ t(n);
                if (0 != v) {
                    var _ = a(v, d.length);
                    ...
                    pattern = [];
                    for (var c = 0; c < d.length; ++c) _.includes(d.length - 1 - c) ? pattern.push(-1) : pattern.push(d[c]);
                    return {
                        error: "Invalid checksum",
        ...
        2: [function(r, e, n) {
            function t(r, e, n, t) {
                for (var o = 0, a = 0, i = [], s = (1 << n) - 1, u = 0; u < r.length; ++u) {
                    var f = r[u];
                    if (f < 0 || f >> e != 0) return null;
                    for (o = o << e | f, a += e; a >= n;) a -= n, i.push(o >> a & s)
                }
                if (t) a > 0 && i.push(o << n - a & s);
                else if (a >= e || o << n - a & s) return null;
                return i
            }
            ...
            function o(r, e) {
                ...
                if (r.length > 74) return {
                    error: "Too long",
                    pos: null
                };
                eposs = [];
                for (var n in a.encodings) {
                    const o = a.encodings[n];
                    var i = a.check(r, e, o);
                    {
                        if (!("data_pattern" in i)) {
                            if (null !== i.error) return {
                                error: i.error,
                                pos: i.pos
                            };
                            var s = t(i.data.slice(1), 5, 8, !1);
                            return null === s ? {
                                error: "Padding error",
                                pos: [r.length - 6]
                                ...
                                pos: [i.hrp.length + 1]
                            } : 0 == i.data[0] && o != a.encodings.BECH32 ? {
                                error: "Bech32 must be used for witness v0 programs",
                                pos: null
                            } : 0 != i.data[0] && o != a.encodings.BECH32M ? {
                                error: "Bech32m must be used for witness v1+ programs",
                                pos: null
                            } : 0 === i.data[0] && 20 !== s.length && 32 !== s.length ? {
                                error: "Invalid witness program length for v0",
                                pos: null
                            } : {
                                error: null,
                                version: i.data[0],
                        ...
                        if (null !== i.data_pattern) {
                            const u = 5 * (i.data_pattern.length - 6 - 1) >> 3;
                            if (i.data_pattern.length - 6 - 1 != ((8 * u + 4) / 5 | 0)) continue;
                            if (0 == i.data_pattern[0] && o != a.encodings.BECH32) continue;
                            if (i.data_pattern[0] > 0 && i.data_pattern[0] <= 16 && o != a.encodings.BECH32M) continue;
                            if (i.data_pattern[0] > 16) continue;
                            if (0 == i.data_pattern[0] && 20 != u && 32 != u) continue;
                            for (var f = [], l = 0; l < i.data_pattern.length; ++l) - 1 == i.data_pattern[l] && f.push(r.length - i.data_pattern.length + l);
                            eposs.push(f)
                        }
                    }
                }
                return 1 == eposs.length ? {
                    error: "Checksum error",
                    pos: eposs[0]
                } : eposs.length > 1 && (eposs.sort(function(r, e) {
                    return r.length - e.length
                }), eposs[0].length < eposs[1].length) ? {
                    error: "Checksum error",
                    pos: eposs[0]
                } : {
                    error: "Checksum error",
